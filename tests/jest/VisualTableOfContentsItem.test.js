...
const VisualTableOfContentsItem = require( '../../resources/experiments/imageBrowsing/components/VisualTableOfContentsItem' );

// Mock the thumbExtractor module
jest.mock( '../../resources/common/thumbExtractor.js', () => ( {
